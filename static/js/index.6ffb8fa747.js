(()=>{"use strict";var e,t,n,a,i={880(e,t,n){var a=n(223),i=n(137),r=n(832);let o=(0,a.Dk)().length?(0,a.Dk)()[0]:(0,a.Wp)({apiKey:"AIzaSyAsZdgR30zAkbh3krAL3C4BoEhLm-rGbCY",authDomain:"malpigaj-a8ce1.firebaseapp.com",projectId:"malpigaj-a8ce1",storageBucket:"malpigaj-a8ce1.firebasestorage.app",messagingSenderId:"602620275958",appId:"1:602620275958:web:e96a29365b6f7c547f10d7",measurementId:"G-ZZSQBM6VGG",databaseURL:"https://malpigaj-a8ce1-default-rtdb.firebaseio.com/"}),l=null;try{l=(0,i.C3)(o)}catch(e){console.error("Realtime Database initialization failed:",e)}let s=(0,r.xI)(o),c=null,d=null,u="login",m=[],p=[],v=!1,g=!1,f=!1;function b(e){return e?String(e).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#039;"):""}function y(){return new Promise(e=>{if(window.google)return void e();let t=0,n=setInterval(()=>{window.google&&(clearInterval(n),e()),++t>50&&(clearInterval(n),console.error("Google API failed to load after attempts"),e())},100)})}function h(e){localStorage.setItem("userInfo",JSON.stringify(e))}function w(){localStorage.removeItem("userInfo")}function E(){return!!l||(console.warn("Realtime DB not available; skipping DB operation."),!1)}async function I(){if(!E())return[];try{let e=(await (0,i.Jt)((0,i.KR)(l,"users"))).val();return e?Object.keys(e).map(t=>e[t]):[]}catch(e){return console.error("fetchAllUsersOnce error",e),[]}}async function $(e){if(E())try{await (0,i.hZ)((0,i.KR)(l,`users/${e.id}`),e)}catch(e){console.error("saveUserToDB error",e)}}async function k(e){if(E())try{await (0,i.TF)((0,i.KR)(l,`users/${e}`))}catch(e){console.error("removeUserFromDB error",e)}}async function S(){if(!E())return[];try{let e=(await (0,i.Jt)((0,i.KR)(l,"events"))).val();return e?Object.keys(e).map(t=>e[t]):[]}catch(e){return console.error("fetchAllEventsOnce error",e),[]}}async function B(e){if(E())try{let t=(0,i.VC)((0,i.KR)(l,"events"));await (0,i.hZ)(t,e)}catch(e){console.error("pushEventToDB error",e)}}async function L(e,t){if(E())try{await (0,i.yo)((0,i.KR)(l,`events/${e}`),t)}catch(e){console.error("updateEventInDB error",e)}}async function j(e){if(E())try{await (0,i.TF)((0,i.KR)(l,`events/${e}`))}catch(e){console.error("removeEventFromDB error",e)}}async function O(){if(!E())return{};try{return(await (0,i.Jt)((0,i.KR)(l,"meta/admins"))).val()||{}}catch(e){return console.error("fetchAdmins error",e),{}}}function A(e){!E()||v||((0,i.Zy)((0,i.KR)(l,"users"),t=>{let n=t.val();m=n?Object.keys(n).map(e=>n[e]):[],localStorage.setItem("users",JSON.stringify(m)),e&&e(m),"post-event"===u&&U(m)}),v=!0)}function D(){!E()||v&&((0,i.AU)((0,i.KR)(l,"users")),v=!1)}function M(e){!E()||g||((0,i.Zy)((0,i.KR)(l,"events"),t=>{let n=t.val();(p=n?Object.keys(n).map(e=>n[e]):[]).sort((e,t)=>(t.createdAt||"").localeCompare(e.createdAt||"")),localStorage.setItem("gameEvents",JSON.stringify(p)),e&&e(p),("view-events"===u||"guest"===u)&&K(p)}),g=!0)}function R(){!E()||g&&((0,i.AU)((0,i.KR)(l,"events")),g=!1)}function T(){f=!1;let e=document.querySelector("#root");if(e){let t,n,a,i;e.innerHTML=`
  ...
  `,document.getElementById("logout-btn")?.addEventListener("click",async()=>{try{await (0,r.CI)(s)}catch(e){console.error("signOut error",e)}V()}),document.getElementById("post-event-btn")?.addEventListener("click",()=>{u="post-event",C()}),document.getElementById("view-events-btn")?.addEventListener("click",()=>{u="view-events",J()}),document.getElementById("profile-btn")?.addEventListener("click",()=>{u="profile",N()}),t&&P())}async function P(){let e=document.getElementById("admin-users-list");e&&(0===m.length&&(m=await I()),e.innerHTML=m.map(e=>`
  ...
  `).join(""),Array.from(e.querySelectorAll(".admin-delete-user")).forEach(e=>{e.addEventListener("click",async()=>{let t=e.getAttribute("data-id");if(confirm("Delete user and remove from events?")){if(await k(t),E()){let e=(await (0,i.Jt)((0,i.KR)(l,"events"))).val();if(e)for(let n of Object.keys(e)){let a=e[n],r=a.participants.filter(e=>e.id!==t);r.length!==a.participants.length&&await (0,i.yo)((0,i.KR)(l,`events/${n}`),{participants:r})}}alert("User removed")}})}))}async function C(){if(f){alert("You must sign in to post events."),u="guest",await Y();return}if(!c)return T();0===m.length&&(m=await I(),localStorage.setItem("users",JSON.stringify(m))),A();let e=document.querySelector("#root");if(!e)return;e.innerHTML=`
    <main class="page-shell">
      <nav class="top-nav">
        <div class="nav-brand">
          <span class="brand-mark">M</span>
  ...
  `,document.getElementById("logout-btn")?.addEventListener("click",async()=>{try{await (0,r.CI)(s)}catch(e){console.error(e)}V()}),document.getElementById("profile-btn")?.addEventListener("click",()=>{u="profile",N()}),document.getElementById("view-events-btn")?.addEventListener("click",()=>{u="view-events",J()}),U(m);let t=document.getElementById("event-form");t?.addEventListener("submit",async e=>{e.preventDefault(),await z()})}function U(e){let t=document.getElementById("participants-list");if(t){if(t.innerHTML=e.map(e=>`
  ...
  `,f?document.getElementById("login-btn")?.addEventListener("click",async()=>{f=!1,R(),D(),await y(),T()}):(document.getElementById("logout-btn")?.addEventListener("click",async()=>{try{await (0,r.CI)(s)}catch(e){console.error(e)}V()}),document.getElementById("profile-btn")?.addEventListener("click",()=>{u="profile",N()}),document.getElementById("post-event-btn")?.addEventListener("click",()=>{u="post-event",C()})),Array.from(document.querySelectorAll(".delete-event")).forEach(e=>{e.addEventListener("click",async()=>{let t=e.getAttribute("data-id");await Z(t)})}),Array.from(document.querySelectorAll(".edit-event")).forEach(e=>{e.addEventListener("click",async()=>{let t=e.getAttribute("data-id");await H(t)})})}(0,r.hg)(s,async e=>{if(d=e,e){if(!c||c.id!==e.uid){let t={id:e.uid,name:e.displayName||"Unknown",email:e.email||"",picture:e.photoURL||`https://ui-avatars.com/api/?name=${encodeURIComponent(e.displayName||"User")}`,loginMethod:"google",loginTime:new Date().toISOString()};c=t,h(t),await $(t)}f=!1,A(),M()}else c=null,w(),D(),R()});let G=null;async function H(e){if(f||!d)return alert("Sign in to edit events");if(!E())return alert("Database not available");let t=(await (0,i.Jt)((0,i.KR)(l,`events/${e}`))).val();if(!t)return alert("Event not found");let n=await O(),a=!!d&&!!n[d.uid];if(t.createdByUid!==d.uid&&!a)return alert("You are not allowed to edit this event");G=e;let r=document.getElementById("edit-modal");if(!r)return;document.getElementById("edit-location").value=t.location||"",document.getElementById("edit-date").value=t.date||"",document.getElementById("edit-time").value=t.time||"",document.getElementById("edit-games").value=t.games||"",r.style.display="block";let o=document.getElementById("edit-cancel");o?.addEventListener("click",F);let s=document.getElementById("edit-event-form");s?.addEventListener("submit",W)}function F(){let e=document.getElementById("edit-modal");if(!e)return;e.style.display="none",G=null;let t=document.getElementById("edit-event-form");t?.removeEventListener("submit",W)}async function W(e){if(e.preventDefault(),!G)return;let t=document.getElementById("edit-location").value,n=document.getElementById("edit-date").value,a=document.getElementById("edit-time").value,i=document.getElementById("edit-games").value;t&&n&&a?(await L(G,{location:t,date:n,time:a,games:i}),alert("Event updated"),F()):alert("Please fill required fields")}async function Z(e){if(f)return alert("Sign in to delete events");if(!d)return alert("Only authenticated users can delete events");if(!E())return alert("Database not available");let t=(await (0,i.Jt)((0,i.KR)(l,`events/${e}`))).val();if(!t)return alert("Event not found");let n=await O(),a=!!d&&!!n[d.uid];if(t.createdByUid!==d.uid&&!a)return alert("You are not allowed to delete this event");confirm("Are you sure you want to delete this event?")&&(await j(e),alert("Event deleted"))}async function Y(){f=!0,u="guest",0===p.length&&(p=await S(),localStorage.setItem("gameEvents",JSON.stringify(p)));let e=document.querySelector("#root");if(!e)return;let t=p.map(e=>{let t=(()=>{if(!e.participants||0===e.participants.length)return"—";if(2===e.participants.length){let[t,n]=e.participants,a="number"==typeof t.score?String(t.score):"—",i="number"==typeof n.score?String(n.score):"—";return`${b(t.name)} ${b(a)} : ${b(i)} ${b(n.name)}`}return e.participants.map(e=>`${b(e.name)}${"number"==typeof e.score?` ${b(String(e.score))}`:""}`).join(", ")})();return`
      <div class="event-card" data-event-id="${e.id}">
        <div class="event-header">
          <h3>${b(e.location)}</h3>
          <p class="event-meta">Posted by ${b(e.createdBy)}</p>
